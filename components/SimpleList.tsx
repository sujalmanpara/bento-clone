...
export const SimpleList = () => {
    ...
    return (
        <div className={`w-[400px] bg-[#1a1a1a] rounded-[32px] p-3 shadow-2xl border mx-auto relative overflow-hidden h-[600px] flex flex-col transition-colors duration-500 ${isCompleted && selectedItem ? 'border-green-500/30' : 'border-white/5'}`}>
